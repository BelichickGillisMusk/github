...
<title>Clean Truck Check Hayward | Mobile CARB Testing in Hayward, CA</title>
<meta name="description" content="Mobile Clean Truck Check CARB testing in Hayward, CA. HD-OBD &amp; Smoke Opacity testing. Licensed CARB tester comes to you. Call 916-890-4427.">
<meta name="geo.position" content="37.6688;-122.0808">
<meta name="geo.placename" content="Hayward, CA">
...
<header class="header" id="header">
  <div class="header-inner">
    <div class="logo"><span>🚚</span> Clean Truck Check Hayward</div>
...
<!-- Hero -->
<section class="hero">
  <h1>Mobile CARB Testing in <span class="highlight">Hayward, CA</span></h1>
  <p>Licensed CARB tester comes directly to your location. HD-OBD &amp; Smoke Opacity testing for trucks, fleets, and RVs across the East Bay.</p>
...
<section class="section fade-up">
  ...
  <div class="benefits-grid">
    ...
    <div class="benefit">
      <div class="icon">🗺️</div>
      <div>
        <h3>East Bay Coverage</h3>
        <p>Serving Hayward, Union City, Fremont, Castro Valley, San Leandro, Alameda, and surrounding areas.</p>
      </div>
    </div>
    <div class="benefit">
      <div class="icon">🔬</div>
...
<!-- Local Content -->
<section class="section fade-up">
  <h2 class="section-title">Hayward &amp; East Bay Service Area</h2>
  <p class="section-sub">Fast, reliable mobile CARB testing throughout the East Bay and Tri-City area</p>
...
<section class="section fade-up">
  ...
  <p class="section-sub">Everything you need to know about Clean Truck Check testing in Hayward</p>
  <div class="faq-list">
    <div class="faq-item">
    ...
    <div class="faq-item">
      ...
      <div class="faq-a"><p>Yes! We are a fully mobile CARB testing service. We bring all required equipment directly to your yard, depot, job site, or residence anywhere in the Hayward and East Bay area.</p></div>
    </div>
    <div class="faq-item">
    ...
    <div class="faq-item">
      ...
      <div class="faq-a"><p>If your vehicle does not pass, we provide a detailed report explaining the failure and recommend trusted repair shops in the Hayward area. After repairs, we offer discounted re-testing to get you back in compliance quickly.</p></div>
    </div>
    <div class="faq-item">
...
<section class="final-cta fade-up">
  <h2>Get Your Truck Tested in Hayward Today</h2>
  <p>Stay CARB compliant — licensed mobile testing at your location across the East Bay.</p>
  <div class="cta-group">
...
<footer class="footer">
  <div class="footer-inner">
    <div>
      <h4>About</h4>
      <p>Clean Truck Check Hayward provides licensed mobile CARB emission testing for heavy-duty diesel trucks, fleets, and RVs in Hayward and the East Bay.</p>
    </div>
    <div>
      <h4>Services</h4>
      <ul>
    ...
    <div>
      ...
      <ul>
        <li>Hayward</li>
        <li>Union City &amp; Fremont</li>
        <li>Castro Valley</li>
        <li>San Leandro &amp; Alameda</li>
        <li>Pleasanton &amp; Livermore</li>
      </ul>
    </div>
    <div>
      <h4>Company</h4>
  ...
  <div class="footer-bottom">&copy; 2026 Clean Truck Check Hayward. All rights reserved.</div>
</footer>
  ...
  "@graph": [
    {
      ...
      "description": "Mobile CARB Clean Truck Check emission testing in Hayward, CA. Licensed tester for HD-OBD and Smoke Opacity testing.",
      "url": "${url.origin}",
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! We are a fully mobile CARB testing service. We bring all required equipment directly to your yard, depot, job site, or residence anywhere in the Hayward and East Bay area."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "If your vehicle does not pass, we provide a detailed report explaining the failure and recommend trusted repair shops in the Hayward area. After repairs, we offer discounted re-testing to get you back in compliance quickly."
          }
        },
        {
          "@type": "Question",
