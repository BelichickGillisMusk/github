...
<title>Clean Truck Check Lodi | Mobile CARB Testing in Lodi, CA</title>
<meta name="description" content="Mobile Clean Truck Check CARB testing in Lodi, CA. HD-OBD &amp; Smoke Opacity testing. Licensed CARB tester comes to you. Call 209-818-1371.">
<meta name="geo.position" content="38.1302;-121.2724">
<meta name="geo.placename" content="Lodi, CA">
<meta name="geo.region" content="US-CA">
<meta name="zipcode" content="95240">
<link rel="canonical" href="${url.origin}/">
<style>
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
:root{--bg:#ffffff;--bg-card:#f4f8fc;--bg-card-hover:#e8f0f8;--navy:#13294B;--carolina:#4B9CD3;--carolina-light:#7BAFD4;--carolina-dark:#3a7fb5;--text:#13294B;--text-muted:#5a6e85;--white:#ffffff;--border:#d0dce8;--shadow:0 4px 24px rgba(19,41,75,0.1);--radius:12px}
...
a{color:var(--carolina);text-decoration:none;transition:color .2s}
...
/* Header */
.header{position:sticky;top:0;z-index:1000;background:rgba(19,41,75,0.97);backdrop-filter:blur(12px);border-bottom:1px solid transparent;transition:border-color .3s,box-shadow .3s}
.header.scrolled{border-bottom-color:rgba(75,156,211,0.3);box-shadow:0 2px 20px rgba(19,41,75,0.2)}
...
.btn-primary{background:var(--carolina);color:var(--white)}
.btn-primary:hover{background:var(--carolina-dark);color:var(--white);transform:translateY(-2px);box-shadow:0 4px 15px rgba(75,156,211,0.4)}
.btn-outline{border:2px solid var(--carolina);color:var(--carolina);background:transparent}
.btn-outline:hover{background:var(--carolina);color:var(--white);transform:translateY(-2px)}
.btn-lg{padding:0.85rem 2rem;font-size:1.05rem}

/* Hero */
.hero{padding:5rem 1.5rem 4rem;text-align:center;background:linear-gradient(180deg,rgba(75,156,211,0.08) 0%,transparent 60%)}
.hero h1{font-size:2.75rem;font-weight:800;line-height:1.15;margin-bottom:1rem;color:var(--navy);animation:fadeUp .8s ease}
.hero h1 .highlight{color:var(--carolina)}
.hero p{font-size:1.15rem;color:var(--text-muted);max-width:640px;margin:0 auto 1.5rem;animation:fadeUp .8s ease .15s both}
.compliance-alert{display:inline-flex;align-items:center;gap:0.5rem;background:rgba(255,171,0,0.1);border:1px solid rgba(255,171,0,0.3);color:#b37700;padding:0.6rem 1.25rem;border-radius:50px;font-weight:600;font-size:0.95rem;margin-bottom:2rem;animation:fadeUp .8s ease .3s both}
...
.trust-badge{display:flex;align-items:center;gap:0.5rem;background:var(--bg-card);padding:0.75rem 1.25rem;border-radius:50px;border:1px solid var(--border);font-weight:600;font-size:0.9rem;color:var(--navy)}
.trust-badge .icon{font-size:1.2rem}

/* Section */
.section{padding:4rem 1.5rem;max-width:1200px;margin:0 auto}
.section-title{text-align:center;font-size:2rem;font-weight:700;margin-bottom:0.5rem;color:var(--navy)}
...
.service-card:hover{transform:translateY(-4px);border-color:var(--carolina);box-shadow:0 8px 30px rgba(75,156,211,0.15)}
...
.service-card .price{color:var(--carolina);font-size:1.5rem;font-weight:700;margin:0.75rem 0}
...
.benefit:hover{border-color:var(--carolina);transform:translateY(-2px)}
.benefit .icon{font-size:1.5rem;flex-shrink:0;width:48px;height:48px;display:flex;align-items:center;justify-content:center;background:rgba(75,156,211,0.12);border-radius:10px}
.benefit h3{font-size:1rem;margin-bottom:0.25rem;color:var(--navy)}
...
.area-list li{display:flex;align-items:center;gap:0.5rem;font-size:1rem;color:var(--navy)}
.area-list li::before{content:'\\2713';color:var(--carolina);font-weight:700}
.info-card{background:var(--bg-card);border:1px solid var(--border);border-radius:var(--radius);padding:2rem}
.info-card h3{font-size:1.25rem;margin-bottom:1rem;color:var(--carolina)}
...
.faq-q{padding:1.25rem 1.5rem;cursor:pointer;display:flex;justify-content:space-between;align-items:center;font-weight:600;font-size:1rem;transition:background .2s;user-select:none;color:var(--navy)}
.faq-q:hover{background:var(--bg-card-hover)}
.faq-q::after{content:'+';font-size:1.25rem;color:var(--carolina);transition:transform .3s;flex-shrink:0;margin-left:1rem}
...
/* Final CTA */
.final-cta{text-align:center;padding:4rem 1.5rem;background:linear-gradient(180deg,transparent 0%,rgba(75,156,211,0.08) 100%)}
.final-cta h2{font-size:2rem;margin-bottom:0.75rem;color:var(--navy)}
.final-cta p{color:var(--text-muted);margin-bottom:2rem;font-size:1.05rem}

/* Footer */
.footer{background:var(--navy);border-top:1px solid rgba(75,156,211,0.3);padding:3rem 1.5rem 1.5rem}
...
.footer a{color:var(--carolina-light)}
.footer a:hover{color:var(--white)}
.footer ul{list-style:none}
.footer li{margin-bottom:0.5rem}
.footer-bottom{max-width:1200px;margin:2rem auto 0;padding-top:1.5rem;border-top:1px solid rgba(255,255,255,0.15);text-align:center;color:rgba(255,255,255,0.5);font-size:0.85rem}
...
<header class="header" id="header">
  <div class="header-inner">
    <div class="logo"><span>🚚</span> Clean Truck Check Lodi</div>
    <a href="tel:2098181371" class="btn btn-primary">📞 Call Now</a>
  </div>
</header>

<!-- Hero -->
<section class="hero">
  <h1>Mobile CARB Testing in <span class="highlight">Lodi, CA</span></h1>
  <p>Licensed CARB tester comes directly to your location. HD-OBD &amp; Smoke Opacity testing for trucks, fleets, and RVs across San Joaquin County and the Central Valley.</p>
  <div class="compliance-alert">⚠️ Biannual testing NOW REQUIRED in 2026</div>
  <div class="cta-group">
    <a href="tel:2098181371" class="btn btn-primary btn-lg">📞 Call Now — 209-818-1371</a>
    <a href="mailto:admin@cleantruckchecklodi.com" class="btn btn-outline btn-lg">📧 Email Us</a>
  </div>
</section>
...
<section class="section fade-up">
  ...
  <div class="benefits-grid">
    ...
    <div class="benefit">
      <div class="icon">🗺️</div>
      <div>
        <h3>Central Valley Coverage</h3>
        <p>Serving Lodi, Stockton, Galt, Elk Grove, Manteca, Tracy, Woodbridge, and surrounding areas.</p>
      </div>
    </div>
    <div class="benefit">
      <div class="icon">🔬</div>
...
<!-- Local Content -->
<section class="section fade-up">
  <h2 class="section-title">Lodi &amp; San Joaquin County Service Area</h2>
  <p class="section-sub">Fast, reliable mobile CARB testing throughout San Joaquin County and the Central Valley</p>
  <div class="local-grid">
    ...
    <div class="info-card">
      ...
      <div class="info-row"><span class="label">Phone</span><span>209-818-1371</span></div>
      <div class="info-row"><span class="label">Email</span><a href="mailto:admin@cleantruckchecklodi.com">admin@cleantruckchecklodi.com</a></div>
      ...
      <div class="info-row"><span class="label">Website</span><a href="https://cleantruckchecklodi.com">cleantruckchecklodi.com</a></div>
    </div>
  </div>
</section>
...
<section class="section fade-up">
  ...
  <p class="section-sub">Everything you need to know about Clean Truck Check testing in Lodi</p>
  <div class="faq-list">
    <div class="faq-item">
    ...
    <div class="faq-item">
      ...
      <div class="faq-a"><p>Yes! We are a fully mobile CARB testing service. We bring all required equipment directly to your yard, depot, job site, or residence anywhere in the Lodi and San Joaquin County area.</p></div>
    </div>
    <div class="faq-item">
    ...
    <div class="faq-item">
      ...
      <div class="faq-a"><p>You can call us directly at 209-818-1371 or email admin@cleantruckchecklodi.com. We typically offer same-week appointments and can often accommodate next-day requests.</p></div>
    </div>
    <div class="faq-item">
      <div class="faq-q">What happens if my truck fails the test?</div>
      <div class="faq-a"><p>If your vehicle does not pass, we provide a detailed report explaining the failure and recommend trusted repair shops in the Lodi area. After repairs, we offer discounted re-testing to get you back in compliance quickly.</p></div>
    </div>
    <div class="faq-item">
...
<section class="final-cta fade-up">
  <h2>Get Your Truck Tested in Lodi Today</h2>
  <p>Stay CARB compliant — licensed mobile testing at your location across San Joaquin County and the Central Valley.</p>
  <div class="cta-group">
    <a href="tel:2098181371" class="btn btn-primary btn-lg">📞 Call 209-818-1371</a>
    <a href="mailto:admin@cleantruckchecklodi.com" class="btn btn-outline btn-lg">📧 Email Us</a>
  </div>
</section>
...
<footer class="footer">
  <div class="footer-inner">
    <div>
      <h4>About</h4>
      <p>Clean Truck Check Lodi provides licensed mobile CARB emission testing for heavy-duty diesel trucks, fleets, and RVs in Lodi and San Joaquin County.</p>
    </div>
    <div>
      <h4>Services</h4>
      <ul>
    ...
    <div>
      <h4>Company</h4>
      <ul>
        <li><a href="tel:2098181371">209-818-1371</a></li>
        <li><a href="mailto:admin@cleantruckchecklodi.com">admin@cleantruckchecklodi.com</a></li>
  ...
  <div class="footer-bottom">&copy; 2026 Clean Truck Check Lodi. All rights reserved.</div>
</footer>
  ...
  "@graph": [
    {
      ...
      "description": "Mobile CARB Clean Truck Check emission testing in Lodi, CA. Licensed tester for HD-OBD and Smoke Opacity testing.",
      "url": "${url.origin}",
      "telephone": "+1-209-818-1371",
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! We are a fully mobile CARB testing service. We bring all required equipment directly to your yard, depot, job site, or residence anywhere in the Lodi and San Joaquin County area."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "You can call us directly at 209-818-1371 or email admin@cleantruckchecklodi.com. We typically offer same-week appointments and can often accommodate next-day requests."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "If your vehicle does not pass, we provide a detailed report explaining the failure and recommend trusted repair shops in the Lodi area. After repairs, we offer discounted re-testing to get you back in compliance quickly."
          }
        },
        {
          "@type": "Question",
